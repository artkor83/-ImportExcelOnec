...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ДобавитьСтрокуДерева(ДеревоВыбора, "ДанныеФормыКоллекция", НСтр("ru = 'Таблица значений'; en = 'Value Table'", Параметры.КодЯзыкаПрограммирования), ОбъектОбработки().КартинкаТипа(Тип("ТаблицаЗначений")));
